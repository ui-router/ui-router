...
JSON="../angular-versions/read-write-json.js"
VERSION=$1;
if [[ "x" == "x$VERSION" ]] ; then
...
$JSON write ../../uirouter-angular/downstream_projects.json  "projects.typescript$(echo $VERSION | sed -e 's/\.//g')" "../integration-tests/typescript-versions/$DIR"
